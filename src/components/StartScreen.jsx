    ...
    <div className="relative h-full w-full bg-[#FFC629] px-6">
      ...
      <div className="absolute top-[160px] left-0 right-0 flex justify-center items-center">
        ...
        <img
          src="/images/john.png"
          alt="John"
          className="relative z-10 -rotate-6 -mr-8 w-44 h-52 object-cover rounded-2xl shadow-lg"
        />
        ...
        <img
          src="/images/elly.png"
          alt="Elly"
          className="relative z-10 rotate-6 -ml-8 w-44 h-52 object-cover rounded-2xl shadow-lg"
        />
